...
class SEGINet(torch.nn.Module):
    ...
    def __init__(self, node_feature,
        ...
        node_out_irreps_scalar = Irreps("{0}x0e".format(output_feature))        
    ...
    def forward(self, data):
        ...
        in_node_feat = self.node_attribute_net(in_edge_index, in_edge_attr)
        ...
        ex_node_feat = self.node_attribute_net(ex_edge_index, ex_edge_attr)  
